...
public class RemoveAGameController implements Initializable {
    ...
    @FXML
    private Button button_removeGame;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        button_removeGame.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                Game selectedGame = availableGamesTableView.getSelectionModel().getSelectedItem();
                if (selectedGame != null && selectedGame.isRemovableGame(selectedGame)) {

                    DatabaseConnection connection = new DatabaseConnection();
                    Connection conn = connection.getDBConnection();
                    String deleteSql = "DELETE FROM games WHERE game_id = " + selectedGame.getGame_id();
                    try {
                        Statement statement = conn.createStatement();
                        statement.executeUpdate(deleteSql);
                    } catch (SQLException e) {
                        Logger.getLogger(RemoveAGameController.class.getName()).log(Level.SEVERE, null, e);
                    }
